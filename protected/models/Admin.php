...
class Admin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('admin_name, admin_pass', 'required'),
			array('admin_name, admin_pass', 'length', 'max'=>45),
            ...
            array('confirm_new_password', 'safe'),

			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, admin_name, admin_pass', 'safe', 'on'=>'search'),
		);
	}
